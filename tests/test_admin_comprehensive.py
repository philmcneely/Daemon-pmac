"""
Test admin router functionality - comprehensive version for higher coverage
"""
...
class TestAdminRouter:
    ...
    def test_create_endpoint(self, mock_get_db, mock_admin_user):
        ...
        response = client.post("/admin/endpoints", json=endpoint_data)
...
class TestAdminEdgeCases:
    ...
    def test_bulk_operations(self, mock_get_db, mock_admin_user):
        ...
        response = client.post("/admin/bulk-operations", json=bulk_data)
