"""
Module: tests.unit.test_projects_unit
Description: Unit tests for projects endpoint functionality and data management
...
Usage:
    pytest tests/unit/test_projects_unit.py -v
