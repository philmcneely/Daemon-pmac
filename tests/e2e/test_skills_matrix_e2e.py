"""
End-to-end tests for the skills_matrix endpoint with flexible markdown support.

These tests validate the skills_matrix endpoint which supports flexible markdown format
for skill levels, endorsements, and skill-grid commentary.
"""
